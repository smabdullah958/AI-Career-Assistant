const Features = () => {
  return (
    ...
    //     <div className="p-6 shadow-lg rounded-2xl hover:shadow-xl">
    //       <h4 className="text-xl font-semibold mb-2">📄 Resume Generator</h4>
    //       <p>Create a professional, ATS-friendly resume in seconds using AI.</p>
    //     </div>
    //     <div className="p-6 shadow-lg rounded-2xl hover:shadow-xl">
    //       <h4 className="text-xl font-semibold mb-2">🎯 Interview Questions</h4>
    //       <p>
    ...
    //     </div>
    //     <div className="p-6 shadow-lg rounded-2xl hover:shadow-xl">
    //       <h4 className="text-xl font-semibold mb-2">📊 ATS Analyzer</h4>
    //       <p>Analyze your resume and get an ATS score with improvement tips.</p>
    //     </div>
    //   </div>
    // </section>
    <section className="py-16 px-8 bg-white">
